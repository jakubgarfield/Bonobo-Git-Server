...
{
    public class ParsedRecievePack
    {
        public ParsedRecievePack (string packId, string repositoryName, IEnumerable<ReceivePackRefChange> refChanges, string pushedByUser, DateTime timestamp)
	    {
            this.PackId = packId;
